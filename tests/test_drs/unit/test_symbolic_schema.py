import pytest
import math
from drs import Module, Variable, Level, Timer, Flow, DRSEngine, DRSConfig
...
def test_expanded_architecture_serialization():
    ...
    assert sub_vars["level_var"]["rate"] == {
        "equation": "(10.0 * SimpleRootModule.control_var)"
    }
    ...
    assert {"module": "", "variable": "control_var"} in sub_connections[
        "variable_reads"
    ]
...
def test_json_schema_validator_hierarchical():
    ...
    valid_tree = {
        ...
        "layout": {"x": 0, "y": 0},
        "variables": {"control_var": {"class": "Variable", "value": 2.0}},
        "children": {
            "sub": {
